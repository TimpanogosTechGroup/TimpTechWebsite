        ...
        <div class="collapse navbar-collapse">
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link" rel="tooltip" title="" data-placement="bottom" href="https://www.facebook.com/Timpanogos-Tech-560674584311834/" target="_blank" data-original-title="Like us on Facebook"><i class="fa fa-facebook-square"></i></a>
                    </li>
                    <li class="nav-item">
...
<div class="page-header header-filter" data-parallax="true"
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <h1 class="title" style="font-weight: 700;">Our Teams.</h1>
                <h4>Explore our teams, and what they are currently working on.</h4>
                <br>
            </div>
        </div>
    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-11 ml-auto mr-auto">
                            <div class="card card-background"
                                 style="background-image: url('<?php echo "../../img/teams/".$row['teamname']."_profile.png"; ?>')">
                                <div class="card-body">
                                    <h6 class="card-category text-info">Team name</h6>
                                    <a href="#pablo">
                                        <h3 class="card-title"><?php echo $row['teamname'] ?></h3>
                                    </a>
                                    <p class="card-description">
                                        <?php echo $row['description'] ?>
                                    </p>
                                    <a href="#pablo" class="btn btn-white btn-link">
                                        <i class="material-icons">subject</i> Join this Team
                                    </a>
                                    <a href="#pablo" class="btn btn-white btn-link" onclick="showProfile('sendID<?php echo $row['ID']; ?>')">
                                        <i class="material-icons">watch_later</i> View Team
                                    </a>
                                </div>
                            </div>
                        </div>
